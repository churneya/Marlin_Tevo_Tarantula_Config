...
#define STRING_CONFIG_H_AUTHOR "(churneya, Tevo Tarantula)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 68.61
    #define DEFAULT_Ki 13.29
    #define DEFAULT_Kd 88.52
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2650 ,2650, 100, 10000 }
